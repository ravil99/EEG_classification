...
from utils_motoric import LSTMClassifier
...
log_folder = f'runs/Correct_{input_dim}_Channels_FILTERED_{l_freq}_{h_freq}_FRACTION_{start}->{end}_LSTM_{layer_dim}_Embedded_Dropout={dropout_rate}_LR={lr}_+Binary_LOSS_dataset={dataset}'
...
if visualize == True:
    ...
    summary(LSTMClassifier(input_dim, hidden_dim, layer_dim, output_dim, dropout_rate),
